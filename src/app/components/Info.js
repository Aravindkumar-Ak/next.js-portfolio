...
const Info = () => {
  return (
    ...
    <div className='text-center p-10 md:px-40'>
        <h1 className='font-extrabold text-5xl mb-4 text-black  dark:text-white'>AravindKumar</h1>
        <h2 className='font-semibold text-2xl md:text-3xl text-teal-500 py-4'>Fullstack Developer</h2>
